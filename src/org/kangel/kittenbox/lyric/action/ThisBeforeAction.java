...
public class ThisBeforeAction extends Action {
    private static Logger log = Logger.getLogger(ThisBeforeAction.class);

    public ThisBeforeAction() {
        super();
        setText("本句提前0.5秒");
        setToolTipText("本句提前0.5秒");
